...
local on_attach = function(_, bufnr)
	...
	nmap("<leader>ld", require("telescope.builtin").lsp_document_symbols, "[L]sp Document [S]ymbols")
...
vim.keymap.set("n", "<leader>do", vim.diagnostic.open_float, { desc = "[D]iagnostics [O]pen" })
